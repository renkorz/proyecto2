...
# Importar "datetime" tanto para agregarle el tiempo como para tambien generar un codigo que ayude a
# facilitar los dias del prestamo consevido hasta el tiempo de finalización de este mismo.
